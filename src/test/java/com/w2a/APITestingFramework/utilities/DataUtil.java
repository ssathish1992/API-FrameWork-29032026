...
public class DataUtil extends BaseTest{
	...
	@DataProvider(name="data",parallel = true)//if parallel = true then it will run parallely and take less time to execute and this can be done in testng.xml also.
